...
public class EthernetConfigDialog extends AlertDialog implements
    ...
    public void buildDialogContent(Context context) {
        ...
        if (mEthEnabler.getManager().isConfigured()) {
            ...
            if (mEthEnabler.getManager().getSharedPreMode().equals(Mode_dhcp)) {
                ...
                mIpaddr.setText(mEthEnabler.getManager().getSharedPreIpAddress(),
                        TextView.BufferType.EDITABLE);
                mDns.setText(mEthEnabler.getManager().getSharedPreDnsAddress(),
                        TextView.BufferType.EDITABLE);
            }
        } else {
            mConTypeDhcp.setChecked(true);
    ...
    public void handle_saveconf() {
        ...
        if (mConTypeManual.isChecked()) {
            ...
            {
                Toast.makeText(this.getContext(), R.string.show_need_setting,
    ...
    public void onClick(DialogInterface dialog, int which) {
        try{
            ...
            String text = this.getContext().getString(R.string.bad_arguments);
