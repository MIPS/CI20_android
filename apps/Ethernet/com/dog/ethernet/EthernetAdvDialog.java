...
public class EthernetAdvDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public void buildDialogContent(Context context) {
        ...
        mProxyIp.setText(mEthEnabler.getManager().getSharedPreProxyAddress(),
                TextView.BufferType.EDITABLE);
        mProxyPort.setText(mEthEnabler.getManager().getSharedPreProxyPort(),
                TextView.BufferType.EDITABLE);
        mProxyExclusionList.setText(mEthEnabler.getManager().getSharedPreProxyExclusionList(),
                TextView.BufferType.EDITABLE);
        this.setInverseBackgroundForced(true);
        this.setButton(BUTTON_POSITIVE, context.getText(R.string.menu_save), this);
        this.setButton(BUTTON_NEGATIVE, context.getText(R.string.menu_cancel), this);
