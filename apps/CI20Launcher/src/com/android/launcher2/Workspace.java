...
public class Workspace extends SmoothPagedView
    ...
    private float wallpaperTravelToScreenWidthRatio(int width, int height) {
        ...
        // This ratio is used to calculate the required wallpaper width
        // need to implement the perspective view. As the wallpaper is
        // rendered from a texture map and the maximum width texture map
        // that the SGX540 can handle is 2048 pixels we clamp the value here
        float ratio = x * aspectRatio + y;
